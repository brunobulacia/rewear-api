...
const mockGarments = [
  {
    ...
    descripcion:
      "Chaqueta de jean clásica Levi's en excelente estado. Talla M, color azul índigo.",
    marca: "Levi's",
    talla: "M",
    categoria: "Chaquetas",
    estilo: "Casual",
  ...
  },
  {
    ...
    descripcion:
      "Vestido midi floral de Zara, temporada primavera. Usado 2 veces, como nuevo.",
    marca: "Zara",
    talla: "S",
    categoria: "Vestidos",
    estilo: "Casual",
  ...
  },
  {
    ...
    descripcion:
      "Nike Air Max 90 en colorway blanco/negro. Talla 42. Muy buen estado.",
    marca: "Nike",
    talla: "42",
    categoria: "Calzado",
    estilo: "Deportivo",
  ...
  },
  {
    ...
    descripcion:
      "Blazer formal negro de H&M. Perfecto para el trabajo. Talla L.",
    marca: "H&M",
    talla: "L",
    categoria: "Blazers",
    estilo: "Formal",
    precio: 180,
    imagenes: [
      "https://m.media-amazon.com/images/I/31MSxWcyI3L._AC_SY1000_.jpg",
    ],
  },
  {
    titulo: "Sweater Oversized Vintage",
    descripcion:
      "Sweater oversized de lana vintage años 90. Color burgundy, talla única.",
    marca: "Sin marca",
    talla: "Única",
    categoria: "Sweaters",
    estilo: "Vintage",
  ...
  },
  {
    ...
    descripcion:
      "Camisa hawaiana vintage 100% algodón. Colores vibrantes, talla M.",
    marca: "Vintage",
    talla: "M",
    categoria: "Camisas",
    estilo: "Retro",
  ...
  },
  {
    ...
    descripcion:
      "Bolso Coach estampado signature marrón/beige. Auténtico, con certificado.",
    marca: "Coach",
    talla: "Única",
  ...
  for (const garment of mockGarments) {
    ...
    await prisma.verification.create({
      data: {
        ...
        wearLevel: ["Excelente", "Muy bueno", "Bueno"][
